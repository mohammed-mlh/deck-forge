...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/browse-decks/prebuilt-:slug", destination: "/decks", permanent: true },
      ...
      { source: "/app/decks", destination: "/decks", permanent: true },
      { source: "/app/decks/:path*", destination: "/decks/:path*", permanent: true },
